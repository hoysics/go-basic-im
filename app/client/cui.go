...
import (
	...
	"github.com/hoysics/basic-im/pkg/sdk"
...
func RunMain() {
	// step1 创建caht的核心对象
	chat = sdk.NewChat("127.0.0.1:9001", "bot", "12312321", "2131")
	...
	if err := os.WriteFile("chat.log", []byte(buf), 0644); err != nil {
		_log.Error(err)
	}
}
